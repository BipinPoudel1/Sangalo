    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($action == "Search") {
            ...
            foreach ($search_terms as $term) {
                $like_term = "%" . $term . "%";
                $conditions[] = "(प्रदेश LIKE ? OR जिल्ला LIKE ? OR स्थानीय_इकाई LIKE ? OR स्थिति LIKE ? OR राजनीतिक_पार्टी LIKE ? OR नाम LIKE ? लिङ्ग LIKE ? OR उमेर LIKE ? कुल_मतहरू LIKE ?)";
          ...
          $types = str_repeat('s', count($params));
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                            <form method='post' action='admin_search.php' style='display:inline;'>
